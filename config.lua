...
Config.DM_maps = {
    ...
    ['map2'] = {
        ...
        zone = {
            ...
            minZ = 31.605163574218,
            maxZ = 43.766887664794,
        },
        spawnpoints = {
            vector4(3481.35, 3759.18, 31.73, 169.2),
            vector4(3504.28, 3752.98, 32.82, 175.97),
            vector4(3520.8, 3748.1, 35.43, 179.43),
            vector4(3546.06, 3741.33, 37.69, 166.12),
            vector4(3627.69, 3723.0, 35.97, 128.24),
            vector4(3611.45, 3700.96, 44.74, 48.76),
            vector4(3593.01, 3695.82, 38.02, 16.86),
            vector4(3522.99, 3695.16, 34.89, 349.93),
            vector4(3496.46, 3701.51, 35.14, 342.84),
            vector4(3451.62, 3720.79, 37.64, 308.24),
            vector4(3456.7, 3710.21, 32.7, 267.61),
        }
    },
}
